...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "table_tabhtau_CaN", _hoc_table_tabhtau,
 "tabhtau_CaN", _hoc_tabhtau,
 0, 0
};
#define ghk ghk_CaN
#define table_tabhtau table_tabhtau_CaN
#define tabhtau tabhtau_CaN
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaN /home/mizzou/LUT_code/single_cell/components/mechanisms/x86_64/CaN.mod\n");
...
static int _reset;
static char *modelname = "N-type calcium current for bladder small DRG neuron soma model";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   mtau = 0.80448 + ( 101.05111 / ( 14.9947 * sqrt ( 3.14 / 2.0 ) ) ) * exp ( - 2.0 * pow( ( ( _lv + 20.0 ) / 14.9947 ) , 2.0 ) ) ;
   htau = tabhtau ( _threadargscomma_ _lv ) ;
   minf = 1.0 / ( 1.0 + exp ( ( - 6.5 - _lv ) / 6.5 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 70.0 ) / 12.5 ) ) ;
    return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   hca = 1.0 / ( 1.0 + pow( ( cai / Kd ) , 4.0 ) ) ;
   ica = pmax * m * ( a * h + ( 1.0 - a ) ) * hca * ghk ( _threadargscomma_ v , cai , cao , 2.0 ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/LUT_code/single_cell/components/mechanisms/modfiles/CaN.mod";
static const char* nmodl_file_text = 
