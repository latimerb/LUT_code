...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nattxs /home/mizzou/LUT_code/single_cell/components/mechanisms/x86_64/nattxs.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "TTX Sensitive Current for bladder small DRG neuron soma model";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
  ...
  minf = 1.0 / ( 1.0 + exp ( ( ( - 25.8 ) - _lv ) / 7.8 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 55.8 ) / 8.9 ) ) ;
   _lalpha_m = 15.5 / ( 1.0 + exp ( ( _lv - 5.0 ) / ( - 12.08 ) ) ) ;
   _lbeta_m = 35.2 / ( 1.0 + exp ( ( _lv + 72.7 ) / 16.7 ) ) ;
   mtau = 1.0 / ( _lalpha_m + _lbeta_m ) ;
   _lalpha_h = ( 0.23688 ) * exp ( - ( _lv + 115.0 ) / 46.33 ) ;
   _lbeta_h = ( 10.8 / 2.5 ) / ( 1.0 + exp ( ( _lv - 11.8 ) / - 11.998 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/LUT_code/single_cell/components/mechanisms/modfiles/nattxs.mod";
static const char* nmodl_file_text = 
