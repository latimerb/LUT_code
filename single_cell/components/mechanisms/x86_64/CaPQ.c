...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaPQ /home/mizzou/LUT_code/single_cell/components/mechanisms/x86_64/CaPQ.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( ( - 5.1 - _lv ) / 3.1 ) ) ;
   mtau = 0.35 + ( 124.9 / ( 18.14 * 1.25 ) ) * exp ( - 2.0 * pow( ( ( _lv + 9.73 ) / 18.14 ) , 2.0 ) ) ;
    return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pmax * m * ghk ( _threadargscomma_ v , cai , cao , 2.0 ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/LUT_code/single_cell/components/mechanisms/modfiles/CaPQ.mod";
static const char* nmodl_file_text = 
