...
#define _gth 0
#define ntau_kdr _thread1data[0]
#define ntau _thread[_gth]._pval[0]
#define ninf_kdr _thread1data[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /home/mizzou/LUT_code/single_cell/components/mechanisms/x86_64/kdr.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KDR Current for bladder small DRG neuron soma model";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
    ninf = 1.0 / ( 1.0 + exp ( - ( _lv + 35.0 ) / 15.4 ) ) ;
   ntau = 7.14085 + ( 636.5557 / ( 17.07686 * sqrt ( 3.14 / 2.0 ) ) ) * exp ( - 2.0 * pow( ( ( _lv + 19.99951 ) / 17.07686 ) , 2.0 ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/LUT_code/single_cell/components/mechanisms/modfiles/kdr.mod";
static const char* nmodl_file_text = 
