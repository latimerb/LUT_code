...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav1p8 /home/mizzou/LUT_code/single_cell/components/mechanisms/x86_64/nav1p8.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "TTX-R (Nav1.8) sodium current for bladder small DRG neuron soma model";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
  ...
  _lalpha_m = 7.21 - 7.21 / ( 1.0 + exp ( ( _lv - 0.063 ) / 7.86 ) ) ;
   _lbeta_m = 7.4 / ( 1.0 + exp ( ( _lv + 53.06 ) / 19.34 ) ) ;
   mtau = 1.0 / ( _lalpha_m + _lbeta_m ) ;
   minf = 1.0 / ( 1.0 + exp ( ( - 11.4 - _lv ) / ( 8.5 ) ) ) ;
   _lalpha_h = 0.003 + 1.63 / ( 1.0 + exp ( ( _lv + 68.5 ) / 10.01 ) ) ;
   _lbeta_h = 0.81 - 0.81 / ( 1.0 + exp ( ( _lv - 11.44 ) / 13.12 ) ) ;
   htau = 1.0 / ( _lalpha_h + _lbeta_h ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 24.2 ) / ( 5.6 ) ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/LUT_code/single_cell/components/mechanisms/modfiles/nav1p8.mod";
static const char* nmodl_file_text = 
