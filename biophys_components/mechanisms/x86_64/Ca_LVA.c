...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_LVA /home/mizzou/LUT_code/biophys_components/mechanisms/x86_64/Ca_LVA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/LUT_code/biophys_components/mechanisms/modfiles/Ca_LVA.mod";
static const char* nmodl_file_text = 
